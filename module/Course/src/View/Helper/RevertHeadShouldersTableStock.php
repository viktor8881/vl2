...
class RevertHeadShouldersTableStock extends AbstractHelper
{
    ...
    private function getWaveMaxValue(array $figures): float
    {
        ...
        foreach ($figures as $figure) {
            if (!$figure->isRevertHeadShoulders()) {
                continue;
            }
            ...
            $minTop = min($cacheCourses[2]->getLastValue(), $cacheCourses[4]->getLastValue());
            $maxBottom = max($cacheCourses[1]->getLastValue(), $cacheCourses[3]->getLastValue(), $cacheCourses[5]->getLastValue());
