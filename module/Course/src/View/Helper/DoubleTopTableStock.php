...
class DoubleTopTableStock extends AbstractHelper
{
    ...
    private function getWaveMaxValue(array $figures): float
    {
        ...
        foreach ($figures as $figure) {
            ...
            $minTop = min($cacheCourses[1]->getLastValue(), $cacheCourses[3]->getLastValue());
            $maxBottom = $cacheCourses[2]->getLastValue();
