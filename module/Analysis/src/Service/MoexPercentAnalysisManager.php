...
use Analysis\Entity\MoexPercentAnalysisCollection;
...
class MoexPercentAnalysisManager extends AbstractManager
{

    /**
     * @param \DateTime $date
     * @return MoexPercentAnalysisCollection
     */
    public function getCollectionByDate(\DateTime $date)
    {
        $coll = new MoexPercentAnalysisCollection();
